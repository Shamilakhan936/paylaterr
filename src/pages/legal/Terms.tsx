          ...
          <div className="prose prose-invert max-w-none">
            <section className="mb-8 sm:mb-12">
              ...
              <p className="text-sm sm:text-base text-muted-foreground">
                By accessing or using Rail Layer's services, you agree to be bound by these Terms of Service. 
                If you do not agree to these terms, please do not use our services.
              </p>
            </section>

            <section className="mb-8 sm:mb-12">
              <h2 className="text-xl sm:text-2xl font-semibold text-foreground mb-3 sm:mb-4">2. Use of Services</h2>
            ...
            <section className="mb-8 sm:mb-12">
              <h2 className="text-xl sm:text-2xl font-semibold text-foreground mb-3 sm:mb-4">3. API Usage</h2>
              <p className="text-sm sm:text-base text-muted-foreground">
            ...
            <section className="mb-8 sm:mb-12">
              <h2 className="text-xl sm:text-2xl font-semibold text-foreground mb-3 sm:mb-4">4. Payment Terms</h2>
              <p className="text-sm sm:text-base text-muted-foreground">
            ...
            <section className="mb-8 sm:mb-12">
              <h2 className="text-xl sm:text-2xl font-semibold text-foreground mb-3 sm:mb-4">5. Contact</h2>
              <p className="text-sm sm:text-base text-muted-foreground">
                Questions about these Terms should be sent to legal@raillayer.com.
              </p>
            </section>
          </div>
        </div>
